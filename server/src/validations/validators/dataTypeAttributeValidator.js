...
const validateDataTypeAttributes = (field, attributeToValidate) => {
    ...
    if ( attributeToValidate != null) {
        switch(field.dataType){
            case "string":
                return validateStringDataTypeAttribute(field, attributeToValidate);
            case "number":
                return validateNumberDataTypeAttribute(field, attributeToValidate);
            case "currency":
                return validateCurrencyDataTypeAttribute(field, attributeToValidate);
            default: 
                return [];
        }
    }
...
const validateStringDataTypeAttribute = (field, attributeToValidate) => {
    const validAttributes = ['min','max', 'validValues'];
    
    return generalValidateDataTypeAttribute(field, attributeToValidate, validAttributes);
    
};

const validateNumberDataTypeAttribute = (field, attributeToValidate) => {
    const validAttributes = ['min','max', 'validValues'];

    return generalValidateDataTypeAttribute(field, attributeToValidate, validAttributes);
};

const validateCurrencyDataTypeAttribute = (value, attributeToValidate) => {
    //valid attributes
    const validAttributes = ['min','max', 'validValues'];
...
const generalValidateDataTypeAttribute = (field, attributeToValidate, validAttributes) => {
